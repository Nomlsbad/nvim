return {
  {
    ...
    keys = {
      ...
      { "<leader>b6", "<cmd>BufferLineGoToBuffer 6<cr>", desc = "Go to 6th buffer" },
      { "<leader>b7", "<cmd>BufferLineGoToBuffer 7<cr>", desc = "Go to 7th buffer" },
      { "<leader>b8", "<cmd>BufferLineGoToBuffer 8<cr>", desc = "Go to 8th buffer" },
      { "<leader>b9", "<cmd>BufferLineGoToBuffer 9<cr>", desc = "Go to 9th buffer" },
